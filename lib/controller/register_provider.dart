...
class RegisterProvider extends ChangeNotifier {
  ...
  TextEditingController selectedTreatment = TextEditingController();
  TextEditingController selectedTreatmentId = TextEditingController();
  ...
  Future<void> getTreatmentList() async {
    ...
    if (response.statusCode == 200) {
      ...
      if (data["status"] == true && data["treatments"] != null) {
        treatmentList = (data["treatments"] as List)
  ...
  Future<void> updatePatient(context) async {
    isLoading = true;
    notifyListeners();
